...
_SUGGESTION_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "\n"
    "Gehe wie folgt vor:\n"
    "1. Vergleiche die letzte Kundenäusserung im Transkript mit den Kundenäusserungen in der Wissensbasis — nicht wörtlich, sondern nach Intention und Bedeutung\n"
